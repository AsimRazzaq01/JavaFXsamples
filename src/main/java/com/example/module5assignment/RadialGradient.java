...
public class RadialGradient extends Application {
    ...
    public RadialGradient(int i, double v, int i1, int i2, int i3, boolean b, CycleMethod cycleMethod, Stop stop, Stop stop1) {
    }
    @Override
    ...
    public void addRectangle(final Scene scene) {
